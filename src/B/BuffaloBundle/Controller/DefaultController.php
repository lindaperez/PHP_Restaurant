...
/*Forgot Password method*/
    public function  newforgotAction() {
        ...
        return $this->render('BBuffaloBundle:Default:envioOlvidoContrasena.html.twig', array(
                    'entity' => $data,
     ...
     public function createforgotAction() {
        ...
        //Buscar usuario con ese correo especifico
            ...
            $em = $this->getDoctrine()->getManager();
            $usuario = $em->getRepository('BBuffaloBundle:TbPersona')
        ->findOneBy(array('vcorreo' => $form['vcorreo']->getData(),
            ...
            if ($usuario!=null){
                ...
                return $this->render('BBuffaloBundle:Default:successOlvidoContrasena.html.twig',array(
                             'entity' => $usuario,
                ));
                }
     ...
     public function mailerPass($vnombre, $icedula, $pass,$to) {
        ...
        $message = \Swift_Message::newInstance()
                ...
                ->setBody(
                $this->renderView(
                        'BBuffaloBundle:Default:mailcontrasena.html.twig',
        ...
        public function maxplatosAction()
{
       ...
       $em = $this->getDoctrine()->getManager();
       $qb=$em->getRepository('BBuffaloBundle:TbRelCompraPlato')->createQueryBuilder('r');
       $qb->addselect('p.vnombre');
       $qb->addselect('r.icantidad');
       $qb->addselect('c.dtfechaCompra');
       $qb->join('BBuffaloBundle:TbPlato', 'p', 'WITH', 'p.id=r.fkIidCplato');
       $qb->join('BBuffaloBundle:TbCompra', 'c', 'WITH', 'c.id=r.fkIidCompra');
 ...
 public function platosSolicitadosAction()
    {
        ...
        return $this->render('BBuffaloBundle:Default:platosSolicitados.html.twig');
 ...
 public function gananciasAction()
    {
        ...
        return $this->render('BBuffaloBundle:Default:ganancias.html.twig');
 ...
 public function gananciasMes2Action()
    {
        ...
        return $this->render('BBuffaloBundle:Default:gananciasMes.html.twig');
 ...
 public function comensalesPorPersonalAction()
    {
        ...
        return $this->render('BBuffaloBundle:Default:comensalesPersonal.html.twig');
